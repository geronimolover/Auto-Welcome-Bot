...
async def auto_welcome(bot: Pr0fess0r_99, msg: Message):
    ...
    WELCOME_TEXT = """Hi {first},

Welcome to AK Movie Group

Just send movie name. Please don't send anything with movie name. Please read the group rules. This group is only meant for movie requesting please don't send anything other"""
